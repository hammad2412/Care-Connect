...
function AppointmentForm() {
  ...
  return (
    <div className="appointment-form-section">
      <div className="form-brand-wrap">
        <Link to="/" className="form-brand">
          <img src={logo} alt="Care Connect" className="navbar-logo" />
          <span className="navbar-title">Care Connect</span>
        </Link>
      </div>

      <div className="form-container">
        <h2 className="form-title">
          <span>Confirm Your Slot</span>
        </h2>
      ...
      <ToastContainer autoClose={8000} limit={1} closeButton={false} />
    </div>
  );
}
